                ...
                <div className="ci1">
                    <div className="form-component">
                        <div className="product-table table">
                            <div className="pt-item1"><p>MÃ NHÂN VIÊN</p></div>
                            <div className="pt-item2"><p>TÊN NHÂN VIÊN</p></div>
                            <div className="pt-item3"><p>GIỚI TÍNH</p></div>
                            <div className="pt-item4"><p>NGÀY SINH</p></div>
                            <div className="pt-item5"><p>ĐỊA CHỈ</p></div>
                            <div className="pt-item6"><p>TÊN TÀI KHOẢN</p></div>
                            <div className="pt-item7"><p>MẬT KHẨU</p></div>
                            {items}
                        </div>
                        <div className="manage-input">
                            <div className="manage-input-item">
                                <div className="input-item">
                                    <label>TÊN NHÂN VIÊN: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                                    <label>NGÀY SINH: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                                    <label>MÃ NHÂN VIÊN: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                            ...
                            <div className="manage-input-item">
                                <div className="input-item">
                                    <label>ĐỊA CHỈ: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                                    <label>SĐT: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                                    <label>TÊN TÀI KHOẢN: </label><input type="text" className="manage-input"/>
                                </div>
                                <div className="input-item">
                                    <label>MẬT KHẨU: </label><input type="text" className="manage-input"/>
                                </div>
                            </div>
                        </div>
