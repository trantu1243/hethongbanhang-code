                        ...
                        <div className="manage-input">
                            <div className="manage-input-item">
                                <div className="input-item">
                                    <label>TỪ NGÀY: </label><input type="text" className="manage-input"/>
                                </div>
                            </div>
                            <div className="manage-input-item">
                                <div className="input-item">
                                    <label>ĐẾN NGÀY: </label><input type="text" className="manage-input"/>
                                </div>
                            </div>
                        </div>
                        <div className="revenue-table table">
                            <div className="rt-item1"><p>MÃ SẢN PHẨM</p></div>
                            <div className="rt-item2"><p>TÊN SẢN PHẨM</p></div>
                            <div className="rt-item3"><p>SL BÁN</p></div>
                            <div className="rt-item4"><p>SL TRẢ</p></div>
                            <div className="rt-item5"><p>TỔNG THU SP</p></div>
                            <div className="rt-item6"><p></p></div>
                            <div className="rt-item7"><p></p></div>
                            <div className="rt-item8"><p></p></div>
                            <div className="rt-item9"><p></p></div>
                            <div className="rt-item10"><p></p></div>
                            <div className="rt-item11"><p></p></div>
                            <div className="rt-item12"><p></p></div>
                            <div className="rt-item13"><p></p></div>
                            <div className="rt-item14"><p></p></div>
                            <div className="rt-item15"><p></p></div>
                            <div className="rt-item16"><p></p></div>
                            <div className="rt-item17"><p></p></div>
                            <div className="rt-item18"><p></p></div>
                            <div className="rt-item19"><p></p></div>
                            <div className="rt-item20"><p></p></div>
                            <div className="rt-item21"><p>TỔNG THU</p></div>
                            <div className="rt-item22"><p></p></div>
                        </div>
                        <div> 
