            ...
            <div className="component-content">
                <div className="ci1">
                    <div className="form-component">
                        <h1>PHIẾU HÀNG</h1>
                        <div>
                            <div className="choice"><p>NHẬP HÀNG</p></div>
                            <div className="choice"><p>XUẤT HÀNG</p></div>
                        </div>
                        <div className="sell-input">
                            ...
                            <div className="input-item">
                                <label>NGÀY LẬP PHIẾU: </label><input type="text" />
                            </div>
                            <div className="input-item">
                        ...
                        <div className="ie-table table">
                            <div className="iet-item1"><p>MÃ SẢN PHẨM</p></div>
                            <div className="iet-item2"><p>TÊN SẢN PHẨM</p></div>
                            <div className="iet-item3"><p>SỐ LƯỢNG NHẬP HÀNG</p></div>
                            <div className="iet-item4"><p>SỐ LƯỢNG XUẤT HÀNG</p></div>
                            <div className="iet-item5"><p>TỔNG TIỀN SP</p></div>
                            <div className="iet-item6"><p></p></div>
                            <div className="iet-item7"><p></p></div>
                            <div className="iet-item8"><p></p></div>
                            <div className="iet-item9"><p></p></div>
                            <div className="iet-item10"><p></p></div>
                            <div className="iet-item11"><p>TỔNG</p></div>
                            <div className="iet-item12"><p></p></div>
                            <div className="iet-item13"><p></p></div>
                        </div>
                        <div>
                ...
                <div className="ci2">
                    <div className="search1">
                        <div className="search-bar">
                            <input type="text" placeholder="Tìm kiếm phiếu hàng" />
                            <div>
