            ...
            <div className="component-content">
                <div className="ci1">
                    <div className="form-component">
                        <h1>BẢNG KÊ BÁN HÀNG</h1>
                        <div className="sell-input">
                            <div className="input-item">
                                <label>MÃ BẢNG KÊ: </label><input type="text" />
                            </div>
                            <div className="input-item">
                                <label>NGÀY LẬP BẢNG KÊ: </label><input type="text" />
                            </div>
                            <div className="input-item">
                        ...
                        <div className="sell-table table">
                            <div className="st-item1"><p>MÃ SẢN PHẨM</p></div>
                            <div className="st-item2"><p>TÊN SẢN PHẨM</p></div>
                            <div className="st-item3"><p>SỐ LƯỢNG TRẢ HÀNG</p></div>
                            <div className="st-item4"><p>SỐ LƯỢNG BÁN RA</p></div>
                            <div className="st-item5"><p>TỔNG TIỀN SP</p></div>
                            <div className="st-item6"><p></p></div>
                            <div className="st-item7"><p></p></div>
                            <div className="st-item8"><p></p></div>
                            <div className="st-item9"><p></p></div>
                            <div className="st-item10"><p></p></div>
                            <div className="st-item11"><p>TỔNG CA BÁN</p></div>
                            <div className="st-item12"><p></p></div>
                        </div>
                        <div>
                            <button className="save-button1">LƯU VÀ XUẤT BẢNG KÊ</button>
                            <button>HỦY BẢNG KÊ</button>
                        </div>
                    </div>
                </div>
                <div className="ci2">
