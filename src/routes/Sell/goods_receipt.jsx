...
function GoodsReceipt(){
    const items = [];
    for (let i = 8; i <= 28; i++) {
        items.push(<div className={`gt-item${i}`} key={i}><p></p></div>);
    }
    return (
            ...
            <div className="component-content">
                <div className="ci1">
                    <div className="form-component">
                        ...
                        <div className="gr-table table">
                            <div className="gt-item1"><p>MÃ SẢN PHẨM</p></div>
                            <div className="gt-item2"><p>TÊN SẢN PHẨM</p></div>
                            <div className="gt-item3"><p>LOẠI SẢN PHẨM</p></div>
                            <div className="gt-item4"><p>SỐ LƯỢNG SẢN PHẨM</p></div>
                            <div className="gt-item5"><p>SIZE</p></div>
                            <div className="gt-item6"><p>MÀU</p></div>
                            <div className="gt-item7"><p>GIÁ</p></div>
                            {items}
                        </div>
