...
function Sale(){
    const items = [];
    for (let i = 6; i <= 20; i++) {
        items.push(<div className={`sat-item${i}`} key={i}><p></p></div>);
    }
    return (
            ...
            <div className="component-content">
                <div className="ci1">
                    <div className="form-component">
                        ...
                        <div className="sale-table table">
                            <div className="sat-item1"><p>MÃ SẢN PHẨM</p></div>
                            <div className="sat-item2"><p>SỐ LƯỢNG SẢN PHẨM</p></div>
                            <div className="sat-item3"><p>PHẦN TRĂM KHUYẾN MÃI</p></div>
                            <div className="sat-item4"><p>GIÁ GỐC</p></div>
                            <div className="sat-item5"><p>GIÁ KHUYẾN MÃI</p></div>
                            {items}
                        </div>
                        <div className="sell-input">
                            ...
                            <div className="input-item">
                                <label>PHẦN TRĂM KHUYẾN MÃI: </label><input type="text" />
                            </div>
                        </div>
                        <div>
                            <button className="save-button1">CẬP NHẬT KM</button>
                            <button>XÓA KM</button>
                        </div>
